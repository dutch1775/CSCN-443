...
; =====================================================================
	...
	help_text		db 'Commands: DIR, LS, COPY, REN, DEL, CAT, SIZE, CLS, HELP, TIME, DATE, VER, HEX, EXIT', 13, 10, 0
	...
	version_msg		db 'MikeOS 4.6.1 - Modded for CSIS-443 ', 13, 10, 0 	; DMO modded 10/2/2020
